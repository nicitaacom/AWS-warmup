import { TWarmupState } from "../interfaces/IWarmUp";

type Stage = {phase:TWarmupState,factor:number,durationDays:number}

export const WARMUP_DURATION_DAYS = 30;
export const MAX_DAILY_EMAILS = 80;
...
day 30-31: n emails
*/
export const DISABLING_STAGES:Stage[] = [
...
day 12-24: n emails
*/
export const ENABLING_STAGES:Stage[] = [
